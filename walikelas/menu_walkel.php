...
<body>
    <div class="sidebar">
        ...
        <a href="walkel_dashboard.php" class="<?= $current_page == 'walkel_dashboard.php' ? 'active' : '' ?>">
            <div class="icon">🏠</div> Home
        </a>
         <a href="datasiswa_walkel.php" class="<?= $current_page == 'datasiswa_walkel.php' ? 'active' : '' ?>">
            <div class="icon">📋</div> Data Siswa
        </a>
        <a href="absensi_walkel.php" class="<?= $current_page == 'absensi_walkel.php' ? 'active' : '' ?>">
            <div class="icon">📊</div> Rekapitulasi
        </a>
        <a href="ketidakhadiran_walkel.php" class="<?= $current_page == 'ketidakhadiran_walkel.php' ? 'active' : '' ?>">
